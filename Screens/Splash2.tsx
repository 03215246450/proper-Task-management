  ...
  return (
    <>
      ...
      <View style={[rncStyles.border, rncStyles.bgWhite, rncStyles.h75, rncStyles.w100]}>
        ...
        <Text style={[rncStyles.fsL, rncStyles.bgWhite, { color: "#000" }, rncStyles.textBold, rncStyles.textCenter]}>Let's create a apace for your workflows </Text>
